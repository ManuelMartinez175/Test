...
int main()
{
    ...
    for (count = 0; count < SIZE; count++)
    {
        ...
        intTable2[count] = (count * 3); // Modify this line to multiply by 3
    ...
    for (count = 0; count < SIZE; count++)
        cout << intTable2[count] << " "; // Display intTable2 values
    cout << endl;
    ...
    for (count = 0; count < SIZE; count++)
    {
        ...
        intTable2[count] = intTable2[count] + 5; // Modify this line
    ...
    {
        intTable[count]++;
        intTable2[count]++; // Modify this line
        doubleTable[count]++;
    }
